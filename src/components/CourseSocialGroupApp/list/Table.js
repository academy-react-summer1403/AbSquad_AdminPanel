...
import GetCourseSocialGroupApi from "../../../@core/services/API/CourseSocialGroup/get.courseSocialGroup.api";
import { AddCourseSocialGroup } from "../AddCourseSocialGroup";
  ...
  return (
    <div className="invoice-list-table-header w-100 me-1 ms-50 mt-2 mb-75">
      <Row>
        ...
        <AddCourseSocialGroup show={show} setShow={setShow} />
      </Row>
    </div>
  );
};
...
const CourseSocialGroupList = () => {
  ...
  const [courseSocialGroup, setCourseSocialGroup] = useState([]);
  const handleGetCourseSocialGroup = async () => {
    const res = await GetCourseSocialGroupApi();
    setCourseSocialGroup(res);
  };
  useEffect(() => {
    handleGetCourseSocialGroup();
  }, []);
