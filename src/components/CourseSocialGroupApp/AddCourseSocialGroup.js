...
import AddCourseSocialGroupApi from "../../@core/services/API/CourseSocialGroup/add.courseSocialGroup.api";
import { AllCourseAdmin } from "../../@core/services/API/AllCoursesAdmin/allCourse.api";

const AddCourseSocialGroup = ({ setShow, show, id }) => {
  //   States
  const [parameters, setParameters] = useState({});

  const handleEditStatus = async (data) => {
    await AddCourseSocialGroupApi(data);
  };
  useEffect(() => {
