...
import AddClassRoomApi from "../../@core/services/API/ClassRoom/add.class.api";
import GetBuildingApi from "../../@core/services/API/Building/get.building.api";
const AddClassRoom = ({ setShow, show }) => {
  //   States
  const [parameters, setParameters] = useState({});
  const handleAddClassRoom = async (data) => {
    await AddClassRoomApi(data);
  };
  useEffect(() => {
    if (parameters.classRoomName) handleAddClassRoom(parameters);
  }, [parameters]);
